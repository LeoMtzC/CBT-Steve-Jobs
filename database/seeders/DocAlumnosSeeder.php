...
class DocAlumnosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $docs->carta_aut = 'https://wallpaperaccess.com/full/5750955.png';
        $docs->estado = 1;
        $docs->save();
        ...
        $docs1->carta_aut = 'https://wallpaperaccess.com/full/5750955.png';
        $docs1->estado = 1;
        $docs1->save();
        ...
        $docs2->carta_aut = 'https://wallpaperaccess.com/full/5750955.png';
        $docs2->estado = 1;
        $docs2->save();
        ...
        $docs3->carta_aut = 'https://wallpaperaccess.com/full/5750955.png';
        $docs3->estado = 1;
        $docs3->save();
        ...
        $docs4->carta_aut = 'https://wallpaperaccess.com/full/5750955.png';
        $docs4->estado = 1;
        $docs4->save();
    }
}
