...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form>
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="grupPEHistAlu">Grupo</label>
                    <input type="text" class="form-control" id="grupPEHistAlu" placeholder="Grupo" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label for="carrPEHistAlu">Carrera</label>
                    <input type="text" class="form-control" id="carrPEHistAlu" placeholder="Carrera" readonly>
                </div>
                <div class="form-group col-md-4">
                    <label for="aulaPEHistAlu">Aula</label>
                    <input type="text" class="form-control" id="aulaPEHistAlu" placeholder="Aula" readonly>
                </div>
            </div>
        </form>
        <hr>
        ...
        <br>
        <div id="btnsPEHistAlu" hidden class="text-right">
            <a id="btnPEDetHistAlu" href="#" class="btn btn-alumno btn-icon-split">
                <span class="icon text-white-50">
                    <i class="fas fa-edit"></i>
                </span>
                <span class="text">Ver detalles</span>
            </a>
            <button id="btnPERepAlu" class="btn btn-docente btn-icon-split">
                <span class="icon text-white-50">
