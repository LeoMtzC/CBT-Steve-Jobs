...
@section('contenido')
    ...
    <div class="card shadow mb-4">  
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-alumno">MTP</h6>
        </div>
        <div class="card-body">
            <p>
            ...
            <form>
                <div class="custom-file">
                    <input type="file" accept="application/pdf" class="custom-file-input" id="subirMTP" lang="es">
                    <label class="custom-file-label" for="subirMTP">Seleccionar Archivo</label>
                </div>
                <div class="mt-3">
                <button type="submit" class="btn btn-primary" id="btnSubirMTP"><i class="fas fa-file-upload"></i> Subir</button>
                </div>
            </form>
        </div>
    </div>
