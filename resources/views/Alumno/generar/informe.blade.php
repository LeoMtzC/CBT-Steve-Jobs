    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            @if ($semestreAlumno == 2 || $semestreAlumno == 3 || $semestreAlumno == 4)  <!-- Semestre 2, 3, 4 → Informe ejecución-->
                <div class="text-left">
                    <a href="{{ route('DBitacora', ['archivo' => 'INFORME_EJECUCION.pdf', 'nombre' => 'Informe de Prácticas de Ejecución.pdf'])}}" 
                    ...
                    <div class="text-left"> 
                        <a href="{{ route('DBitacora', ['archivo' => 'INFORME_SERVICIO.pdf', 'nombre' => 'Informe de Servicio Social.pdf'])}}" 
                        type="button" class="btn btn-alumno" id="genInforme"><i class="fas fa-file-download"></i> Generar</a>
                    </div>                              
                            @if($semestreAlumno == 6)   <!-- Semestre 6 → Informe estadías-->
                            <div class="text-left">
                                <a href="{{ route('DBitacora', ['archivo' => 'INFORME_ESTADIAS.pdf', 'nombre' => 'Informe de Estadías Profesionales.pdf'])}}" 
                                type="button" class="btn btn-alumno" id="genInforme"><i class="fas fa-file-download"></i> Generar</a>
                            </div>                                                            
                            @endif
                    @endif
            @else   <!-- Semestre 1 → Informe observación-->
                <div class="text-left">
                    <a href="{{ route('DBitacora', ['archivo' => 'INFORME_OBSERVACION.pdf', 'nombre' => 'Informe de Prácticas de Observación.pdf'])}}" 
                    type="button" class="btn btn-alumno" id="genInforme"><i class="fas fa-file-download"></i> Generar</a>
                </div>
            @endif
        </div>
